...
import { pendingBookings } from "@screens/home/mock/MockData";
...
const ReusableTab: React.FC<IReusableTabProps> = ({
  data,
  statusType = "pending",
}) => {
   ...
   * ? Actions
   */
  const { onSetBookingItem, onSetChatCount } = bookingActions;
